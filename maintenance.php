<?php
   ...
   * @copyright 2012
   * @version $Id: maintenance.php, v2.00 2011-04-20 10:12:05 gewa Exp $
   */
...
<div id="container">
  <div class="wrapper">
    ...
    <h1><?php echo Lang::$word->M_H1;?></h1>
    <h2 class="subtitle"><?php echo Lang::$word->M_H2;?></h2>
    <div id="dashboard" class="row">
      <div class="col grid_6">
        <div class="dash weeks_dash">
          ...
          <span class="dash_title"><?php echo Lang::$word->M_WEEKS;?></span> </div>
      </div>
      <div class="col grid_6">
        <div class="dash days_dash">
          ...
          <span class="dash_title"><?php echo Lang::$word->M_DAYS;?></span> </div>
      </div>
      <div class="col grid_6">
        <div class="dash hours_dash">
          ...
          <span class="dash_title"><?php echo Lang::$word->M_HOURS;?></span> </div>
      </div>
      <div class="col grid_6">
        <div class="dash minutes_dash">
          ...
          <span class="dash_title"><?php echo Lang::$word->M_MINUTES;?></span> </div>
      </div>
    </div>
