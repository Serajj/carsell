        ...
        formatBlocks: function (tag) {
            ...
            $.each(nodes, $.proxy(function (i, node) {
                if (node.tagName !== 'LI') {
                    ...
                    if (tag === 'p') {
                        if ((node.tagName === 'P' && parent.size() != 0 && parent[0].tagName === 'BLOCKQUOTE') ||
		...
		modalTemplatesInit: function()
		{
			$.extend( this.opts,
			{
				...
				+ '<section class="footer">'
					...
					+ '<button class="redactor_btn_modal_close wojo negative button" id="redactor_image_delete_btn">' + this.opts.curLang._delete + '</button>'
				...
				+ '<section class="footer">'
					+ '<div class="wojo two fluid buttons">'
					+ '<button class="redactor_btn_modal_close wojo negative button">' + this.opts.curLang.cancel + '</button>'
					+ '<button class="redactor_modal_action_btn wojo positive button" id="redactor_insert_link_btn">' + this.opts.curLang.insert + '</button>'
					+ '</div>'
				+ '</section>',
				...
				+ '<section class="footer">'
					+ '<div class="wojo two fluid buttons">'
					+ '<button class="redactor_btn_modal_close wojo negative button">' + this.opts.curLang.cancel + '</button>'
					+ '<button class="redactor_modal_action_btn wojo positive button" id="redactor_insert_table_btn">' + this.opts.curLang.insert + '</button>'
					+ '</div>'
				+ '</section>',
				...
				+ '<section class="footer">'
					+ '<div class="wojo two fluid buttons">'
					+ '<button class="redactor_btn_modal_close wojo negative button">' + this.opts.curLang.cancel + '</button>'
					+ '<button class="redactor_modal_action_btn wojo positive button" id="redactor_insert_video_btn">' + this.opts.curLang.insert + '</button>'
					+ '</div>'
				+ '</section>'
