<?php
   ...
   * @copyright 2014
   * @version $Id: class_meta.php,v 1.00 2014-01-10 21:12:05 gewa Exp $
   */
  ...
  class parseMeta
  {
      ...
      private function __construct($text)
      {
          ...
          self::$contents = self::process_text($text);
      }
	  ...
	  public static function instance($text){
		  if (!self::$instance){ 
			  self::$instance = new parseMeta($text); 
		  } 
